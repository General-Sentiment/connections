...
export type ProfilePrompt = { id: number; text: string; createdAt?: string; updatedAt?: string; addedAt?: string; addedBy?: { name: string; slug: string }; author?: { name: string; slug: string } };
